...
import { createMovieCard, createMovieCardfavorite } from "./movie-card.js";
...
// fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${api_key}&sort_by=popularity.desc&include_adult=false&page=${currentPage}&${urlParam}`).then(response => {
...
fetchDataFromServer(
  ...
  `;
    ...
    for (const movie of movieList) {
      const movieCard = createMovieCardfavorite(movie);
